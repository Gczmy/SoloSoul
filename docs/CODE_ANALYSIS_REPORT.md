...
| P030 | P2 | i18n | `src/pages/settings/CloudSyncPage.tsx:603` | `common:enabled` / `common:disabled` 双语均缺 key 且无 defaultValue，UI 直接渲染原始 key 字符串 | `[ ]` 待修复 |

## 修复进度

- 已完成：4 / 30（P0: 0，P1: 4，P2: 0）
- 当前处理：P005
