...
> 最后更新：2026-09-17（轮次 6：按用户要求逐项修复，已完成 P037、P038、P040、P043）
...
- 已关闭：39 / 49（含已修复及已确认设计例外；本轮完成 P037、P038、P040、P043）
- 未关闭：10 项（P012、P039、P041–P042、P044–P049）
- 当前处理：P041。原有子模块与生成资源改动保留；本轮修复按明确路径独立提交。
