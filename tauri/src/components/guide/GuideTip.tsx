...
const STYLES = {
  tip: {
    ...
    icon: <Lightbulb size={ICON_SIZE.md} style={{ color: '#5cb85c', flexShrink: 0 }} />,
  },
  warning: {
    border: '1px solid rgba(211, 84, 79, 0.22)',
    background: 'rgba(211, 84, 79, 0.08)',
    icon: <AlertTriangle size={ICON_SIZE.md} style={{ color: '#d3544f', flexShrink: 0 }} />,
  },
  info: {
    border: '1px solid rgba(91, 124, 153, 0.22)',
    background: 'rgba(91, 124, 153, 0.08)',
    icon: <Info size={ICON_SIZE.md} style={{ color: '#6b8fa8', flexShrink: 0 }} />,
  },
};
