...
export function AboutPage() {
  ...
  const links = [
    ...
    { labelKey: 'privacy_policy', url: 'https://github.com/Gczmy/SoloSoul/blob/master/docs/PRIVACY_POLICY.md', icon: <Shield size={14} /> },
    { labelKey: 'terms_of_service', url: 'https://github.com/Gczmy/SoloSoul/blob/master/docs/TERMS_OF_SERVICE.md', icon: <Info size={14} /> },
  ];
