      ...
      helpLinks: [
        {
          ...
          description: t('common:guide_help_sensitivity_desc') ?? '了解不同敏感度等级的含义与安全策略',
          href: '/help?id=sensitivity',
        },
        {
          title: t('common:guide_help_objects') ?? '对象管理',
          description: t('common:guide_help_objects_desc') ?? '对象的创建、编辑、历史回溯与回收站管理',
          href: '/help?id=objects',
        },
        {
          title: t('common:guide_help_getting_started') ?? '快速开始',
          description: t('common:guide_help_getting_started_desc') ?? '了解 SoloSoul 基础操作与工作区布局',
      ...
      helpLinks: [
        {
          ...
          description: t('common:guide_help_templates_desc') ?? '模板的创建、编辑、字段管理与废弃处理',
          href: '/help?id=templates',
        },
        {
          title: t('common:guide_help_create_object') ?? '创建对象',
          description: t('common:guide_help_create_object_desc') ?? '使用模板创建对象，快速录入结构化数据',
          href: '/help?id=objects',
        },
        {
          title: t('common:guide_help_objects') ?? '对象管理',
    ...
    },
    {
      ...
      helpLinks: [
        ...
        },
        {
          ...
          description: t('common:guide_help_attachments_desc') ?? '附件的上传、下载、重命名与回收站管理',
