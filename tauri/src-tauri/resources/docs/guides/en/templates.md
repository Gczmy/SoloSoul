...
Templates are preset object structures that help you quickly create records in standard formats. SoloSoul includes several built-in templates.
...
3. The system automatically expands the corresponding field form
4. Fill in and save
...
4. Fill in passport number, nationality, issue date, expiry date
5. Click **Save**
<!--/STEPPER-->
