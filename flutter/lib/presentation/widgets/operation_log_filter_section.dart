                ...
                child: SingleChildScrollView(
                  ...
                  child: Row(
                    children: [
                      ...
                      const SizedBox(width: 4),
                      OperationFilterChip(
                        label: l10n.operationPlatformWindows,
                        icon: Icons.desktop_windows,
                        isSelected: deviceFilters.contains('windows'),
                        color: Colors.grey.shade700,
                        onSelected: (_) => _toggleFilter(ref, deviceFilters, 'windows', logDeviceFilterProvider),
                      ),
                      const SizedBox(width: 4),
                      OperationFilterChip(
                        label: l10n.operationPlatformLinux,
                        icon: Icons.computer,
                        isSelected: deviceFilters.contains('linux'),
                        color: Colors.grey.shade700,
                        onSelected: (_) => _toggleFilter(ref, deviceFilters, 'linux', logDeviceFilterProvider),
                      ),
                    ],
                  ),
                ),
