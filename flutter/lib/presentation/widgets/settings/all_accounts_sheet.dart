...
class AllAccountsSheet extends StatelessWidget {
  ...
  Widget _buildAccountTile(
    ...
    return Material(
      ...
      child: InkWell(
        borderRadius: BorderRadius.circular(12),
        onTap: isSelected ? null : () => onSelectAccount(account.id),
        child: Padding(
          ...
          child: Row(
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      l10n.accountLastLoginLabel(
                        _formatDateTime(
                          account.lastLoginAt,
                          naFallback: l10n.commonNA,
                        ),
                      ),
              ...
              if (account.recentDevices.isNotEmpty) ...[
                const SizedBox(width: 8),
                Icon(
                  getDeviceIcon(account.recentDevices.first.deviceName),
                  size: 18,
                  color: theme.colorScheme.onSurfaceVariant,
                ),
              ],
