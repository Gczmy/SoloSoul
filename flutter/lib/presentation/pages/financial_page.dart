            ...
            PredefinedObjectSection(
              ...
              displayItemBuilder:
                  (account, itemMap) => EntryCardWidget<UnifiedObject>(
                    ...
                    isRestricted: true,
                    formatAllFields:
                        (a) => l10n.financialFormatBankAccount(a.toFormattedStringLocalized(l10n)),
                    itemData: itemMap,
            ...
            PredefinedObjectSection(
              ...
              displayItemBuilder:
                  (card, itemMap) => EntryCardWidget<UnifiedObject>(
                    ...
                    historyFieldId: 'card',
                    isRestricted: true,
                    formatAllFields: (c) => l10n.financialFormatCard(c.toFormattedStringLocalized(l10n)),
                    itemData: itemMap,
                    fieldPrefix: 'card',
                    excludeFields: const {'title'},
                  ),
            ...
            PredefinedObjectSection(
              ...
              displayItemBuilder:
                  (taxId, itemMap) => EntryCardWidget<UnifiedObject>(
                    ...
                    isRestricted: true,
                    formatAllFields: (t) => l10n.financialFormatTaxId(t.toFormattedStringLocalized(l10n)),
                    itemData: itemMap,
                    fieldPrefix: 'taxId',
                    excludeFields: const {'title'},
                  ),
