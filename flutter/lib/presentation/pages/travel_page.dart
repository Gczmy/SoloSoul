        ...
        const SizedBox(height: 16),
            PredefinedObjectSection(
              ...
              displayItemBuilder: (passport, itemMap) => EntryCardWidget<UnifiedObject>(
                ...
                isRestricted: true,
                formatAllFields: (p) => l10n.travelFormatPassport(p.toFormattedStringLocalized(l10n)),
                itemData: itemMap,
            ...
            PredefinedObjectSection(
              ...
              displayItemBuilder: (visa, itemMap) => EntryCardWidget<UnifiedObject>(
                ...
                historyFieldId: 'visa',
                isRestricted: true,
                formatAllFields: (v) => l10n.travelFormatVisa(v.toFormattedStringLocalized(l10n)),
                itemData: itemMap,
                fieldPrefix: 'visa',
                excludeFields: const {'title'},
              ),
            ...
            PredefinedObjectSection(
              ...
              displayItemBuilder: (item, itemMap) => EntryCardWidget<UnifiedObject>(
                ...
                formatAllFields: (t) => l10n.travelFormatHistory(t.toFormattedStringLocalized(l10n)),
                itemData: itemMap,
                fieldPrefix: 'travel',
