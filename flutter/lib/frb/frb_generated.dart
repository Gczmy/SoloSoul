...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => -754885811;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<void> crateApiFrbCreateZipPackage({
  ...
  Future<void> crateApiFrbDecryptFile({
  ...
  Future<void> crateApiFrbEncryptFile({
    required String srcPath,
    required String dstPath,
    required String progressPath,
    required String cancelPath,
  ...
  Future<List<String>> crateApiFrbExtractZipPackage({
  ...
  Future<String> crateApiFrbInspectBackup({required String backupPath});
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<void> crateApiFrbCreateZipPackage({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiFrbCreateZipPackageConstMeta,
        argValues: [srcDir, dstPath],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiFrbCreateZipPackageConstMeta =>
      const TaskConstMeta(
        debugName: "frb_create_zip_package",
        argNames: ["srcDir", "dstPath"],
      );
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_String(dstPath, serializer);
          sse_encode_String(progressPath, serializer);
          sse_encode_String(cancelPath, serializer);
          pdeCallFfi(
            generalizedFrbRustBinding,
            serializer,
            funcId: 6,
        ...
        constMeta: kCrateApiFrbDecryptFileConstMeta,
        argValues: [srcPath, dstPath, progressPath, cancelPath],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiFrbDecryptFileConstMeta => const TaskConstMeta(
    debugName: "frb_decrypt_file",
    argNames: ["srcPath", "dstPath", "progressPath", "cancelPath"],
  );
  ...
  Future<void> crateApiFrbEncryptFile({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiFrbEncryptFileConstMeta,
        argValues: [srcPath, dstPath, progressPath, cancelPath],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiFrbEncryptFileConstMeta => const TaskConstMeta(
    debugName: "frb_encrypt_file",
    argNames: ["srcPath", "dstPath", "progressPath", "cancelPath"],
  );
  ...
  Future<List<String>> crateApiFrbExtractZipPackage({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiFrbExtractZipPackageConstMeta,
        argValues: [zipPath, dstDir],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiFrbExtractZipPackageConstMeta =>
      const TaskConstMeta(
        debugName: "frb_extract_zip_package",
        argNames: ["zipPath", "dstDir"],
      );
  ...
  Future<String> crateApiFrbInspectBackup({required String backupPath}) {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiFrbInspectBackupConstMeta,
  ...
  TaskConstMeta get kCrateApiFrbInspectBackupConstMeta => const TaskConstMeta(
    debugName: "frb_inspect_backup",
    argNames: ["backupPath"],
  );
