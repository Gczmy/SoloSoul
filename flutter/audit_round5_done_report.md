...
### 2.1 ProfileSectionEditor switch → Map 派发
...
### 2.2 operation_log_aggregator switch → Map 派发
...
## 四、freezed / riverpod_generator 评估
...
```bash
$ dart analyze lib/presentation/providers/profile_section_editor.dart lib/presentation/providers/services/operation_log_aggregator.dart
Analyzing profile_section_editor.dart, operation_log_aggregator.dart...
No issues found!
```
...
| 问题 | 优先级 | 说明 |
|------|--------|------|
| 数据模型可变性 (ProfileData 等) | P0 | 需要 immutable pattern |
| emptyAllTrash / restoreItem mutation | P0 | 改为纯函数 |
